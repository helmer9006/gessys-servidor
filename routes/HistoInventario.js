...
router.get("/:idInventario", auth, HistoInventarioController.traerHistoInventario);
...
router.delete("/:idHistoInventario", auth, HistoInventarioController.eliminarHistoInventario);
